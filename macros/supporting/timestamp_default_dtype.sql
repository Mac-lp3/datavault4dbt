...
{%- if global_var is mapping -%}
    ...
    {%- else -%}
        {%- if execute -%}
            {%- do exceptions.warn("Warning: You have set the global variable 'datavault4dbt.timestamp_default_dtype' to a dictionary, but have not included the adapter you use (duckdb) as a key. Applying the default value.") -%}
        {% endif %}
